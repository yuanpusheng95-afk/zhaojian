...
export async function appendRecord(client: PoolClient, sessionId: string, newRecord: any) {
...
export async function findRecords(
  client: PoolClient,
  sessionId: string,
  query: SessionRecordQuery & Record<string, any> = {},
): Promise<any[]> {
...
export async function findOpenOperations(
  ...
  sessionId: string,
  lane: string,
  options: SessionRecordQuery & Record<string, any> = {},
): Promise<any[]> {
